...
public class Cliente implements Serializable {
    ...
    @Pattern(regexp = "^[0-9]{1,15}$", message = "El DUI debe contener solo números y tener un máximo de 15 dígitos")
    private String dui;
    ...
    @Pattern(regexp = "^(|[0-9]{1,15})$", message = "La licencia debe contener solo números y tener un máximo de 15 dígitos")
